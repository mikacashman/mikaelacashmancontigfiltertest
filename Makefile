SERVICE = mikaelacashman_contigfilter
SERVICE_CAPS = mikaelacashman_ContigFilter
SPEC_FILE = mikaelacashman_ContigFilter.spec
URL = https://kbase.us/services/mikaelacashman_contigfilter
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
